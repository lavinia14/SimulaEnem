        ...
        <div class="barra">
            <!--div class="barra-conteudo">
                ...
                <div class="barra-diretorio">
                    <a href='login.php' style="color:#4B49AC">Login</a>
                    <a href='register.php' style="color:#4B49AC">Cadastro</a>
                    <a class="barra-link-sobrenos" style="color:#4B49AC" href="sobrenos.php">Sobre nós</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <br>
                  <button type="button" class="col-md-4 card card-table-link card-light-blue"><a href="register.php">Cadastre-se</a></button>
                </div>
